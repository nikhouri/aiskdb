...
src:first .z.x,enlist"aiskdb"
system"l tick/",(first .z.x,enlist"sym"),"-schema.q"
...
tick:{init[];if[not min(`time`mmsi~2#key flip value@)each t;'`timemmsi];@[;`mmsi;`g#]each t;d::.z.D;if[l::count y;L::`$":",y,"/",x,10#".";l::ld d]};

endofday:{end d;d+:1;if[l;hclose l;l::0(`.u.ld;d)]};
ts:{if[d<x;if[d<x-1;system"t 0";'"more than one day?"];endofday[]]};

if[system"t";
 .z.ts:{pub'[t;value each t];@[`.;t;@[;`mmsi;`g#]0#];i::j;ts .z.D};
 upd:{[t;x]
